...
class Nocks_WC_Gateway_Ethereum extends Nocks_WC_Gateway_Abstract
{
	...
	{
		return __('Ethereum', 'nocks-checkout-for-woocommerce');
	}
	...
	{
		return __('Accept Ethereum payments with Nocks', 'nocks-checkout-for-woocommerce');
	}
	...
	protected function getDefaultDescription ()
	{
		...
		return __('Pay with Ethereum', 'nocks-checkout-for-woocommerce');
	}
	...
	public function payment_fields() {
		...
		try {
			...
			$html = '<br/>' . __('Estimated total amount of Ethereum: ', 'nocks-checkout-for-woocommerce') . ' ' . $this->getSourceCurrency() . ' ' . $amount;
		} catch(Exception $e) {
			$html = '<br/>' . __('We cannot calculate the amount of Ethereums at this moment.', 'nocks-checkout-for-woocommerce');
		}
